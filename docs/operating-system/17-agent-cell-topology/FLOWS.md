# Agent Cell Topology Flows

## Main lifecycle

1. Lead assigns independent area, worker reads area docs, performs scoped work, leaves handoff, reviewer records findings, current-state/progress are synchronized.
