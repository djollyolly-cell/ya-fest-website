...
- Entry condition: a worker is preparing to change Agent Cell Topology.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `docs/operating-system/04-agent-runtime/README.md`; compare with code/tests where relevant; record conflicts as open questions.
