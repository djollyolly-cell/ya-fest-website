...
This area exists to keep the project anchored to why Ya-Fest exists and how the brand should be understood by people, search engines, and AI systems.

## Role in the full product

It protects the project purpose, positioning, success criteria, scope boundaries, and strategic narrative for Ya-Fest and gives future workers a clear place to make decisions, check status, and leave evidence.
