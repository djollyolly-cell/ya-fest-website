...
- Entry condition: a worker is preparing to change Entity Memory.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `master_klassy_i_intensivy.md`, `pedagogi_i_napravleniya.md`, `teatr_kino_sochi_tvorcheskiy_kampus.md`; compare with code/tests where relevant; record conflicts as open questions.
