...
This area exists to record what is actually true now so old plans do not get mistaken for completed work.

## Role in the full product

It protects the implementation status, known working surfaces, skeletons, risks, and current canonical status notes for Ya-Fest and gives future workers a clear place to make decisions, check status, and leave evidence.
