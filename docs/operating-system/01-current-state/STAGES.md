...
- Entry condition: a worker is preparing to change Current State.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `website/src/App.tsx`, `website/public/sitemap.xml`, `HTML landing for claude/index.html`, `docs/superpowers/specs/2026-06-29-yafest-geo-design.md`; compare with code/tests where relevant; record conflicts as open questions.
