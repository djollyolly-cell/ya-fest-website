# Security and Multitenancy Flows

## Main lifecycle

1. Security-sensitive change identifies public surface, defines guards, tests invalid input, records residual risk, then updates affected gates.
