...
This area exists to define verification, review, and evidence expectations before work is called complete.

## Role in the full product

It protects the test commands, visual QA, content QA, link checks, schema validation, and review records for Ya-Fest and gives future workers a clear place to make decisions, check status, and leave evidence.
