# QA and Reviews Flows

## Main lifecycle

1. QA starts from affected area gates, runs relevant automated checks, performs manual checks where needed, stores review notes, and updates progress/state.
