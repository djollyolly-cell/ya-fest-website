# Capability Operations Flows

## Main lifecycle

1. Operator identifies external action, checks approval requirement, executes only if approved, verifies effect, and records handoff.
