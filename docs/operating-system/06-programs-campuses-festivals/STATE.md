# Programs, Campuses, and Festivals State

## Implemented

Source materials for campuses, teachers, and festivals exist. A normalized product data contract is not yet confirmed as implemented across all active routes.
