# Programs, Campuses, and Festivals Goal

## Why this area exists

This area exists to own the product map for festivals, campuses, laboratories, workshops, intensives, and archive events.

## Role in the full product

It protects the program entities, dates, audiences, pricing, inclusions, teachers, locations, results, and archive status for Ya-Fest and gives future workers a clear place to make decisions, check status, and leave evidence.
