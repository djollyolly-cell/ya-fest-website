# Programs, Campuses, and Festivals Flows

## Main lifecycle

1. Product is defined from source evidence, mapped into route/content data, published with visible facts, then linked from sitemap, facts, and relevant marketing surfaces.
