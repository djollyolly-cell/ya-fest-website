...
- Entry condition: a worker is preparing to change Implementation Roadmap.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `docs/superpowers/specs/2026-06-29-yafest-geo-design.md`; compare with code/tests where relevant; record conflicts as open questions.
