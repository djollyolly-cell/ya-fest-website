# Implementation Roadmap Flows

## Main lifecycle

1. Roadmap is updated from current-state and area states, selects next safe scope, then implementation updates progress and affected states.
