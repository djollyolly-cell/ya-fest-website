# Migration and Rollout Flows

## Main lifecycle

1. Rollout chooses target surface, maps routes, prepares compatibility notes, verifies crawlers and forms, then records production status.
