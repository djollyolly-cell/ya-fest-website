# Marketing and Analytics Flows

## Main lifecycle

1. Campaign plan moves to import files, account changes happen only with approval, analytics verifies conversions, and audit logs record outcomes and next corrections.
