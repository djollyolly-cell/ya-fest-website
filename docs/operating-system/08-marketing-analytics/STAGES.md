# Marketing and Analytics Stages
...
- Entry condition: a worker is preparing to change Marketing and Analytics.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `yandex_direct_relaunch_plan.md`, `yandex_direct_account_audit.md`, `yandex_direct_camp_keywords.md`, `yandex_direct_competitors.md`, `HTML landing for claude/analytics.js`; compare with code/tests where relevant; record conflicts as open questions.
