# Marketing and Analytics State

## Implemented

Advertising and audit source documents exist, and recent git history mentions Yandex Metrika goals and verification. Active account state must be verified before treating any campaign plan as live.
