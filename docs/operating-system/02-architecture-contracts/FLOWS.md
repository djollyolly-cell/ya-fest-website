# Architecture Contracts Flows

## Main lifecycle

1. Architecture decisions start with a documented DECISIONS.md entry, then affected contracts, implementation steps, tests, and current state are updated.
