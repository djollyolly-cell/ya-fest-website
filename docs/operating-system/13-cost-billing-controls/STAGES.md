# Cost and Billing Controls Stages
...
- Entry condition: a worker is preparing to change Cost and Billing Controls.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `yandex_direct_relaunch_plan.md`, `yandex_direct_account_audit.md`; compare with code/tests where relevant; record conflicts as open questions.
