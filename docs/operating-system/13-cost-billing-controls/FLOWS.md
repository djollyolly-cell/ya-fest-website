# Cost and Billing Controls Flows

## Main lifecycle

1. Cost change starts as proposal, receives approval, is applied in provider/account, then logged with spend assumptions and verification.
