# Deploy Operations Flows

## Main lifecycle

1. Deploy change prepares assets, runs checks, publishes to target surface, verifies public URLs, records deploy status and exact scope in handoff.
