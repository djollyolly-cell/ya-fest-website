# Applications and Communications Flows

## Main lifecycle

1. User selects product context, submits application data, backend validates and sends notification, UI confirms result, and handoff records any deployment or test gap.
