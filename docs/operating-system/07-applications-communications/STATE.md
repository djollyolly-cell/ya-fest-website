# Applications and Communications State

## Implemented

Contact forms and contact links exist in both surfaces. The canonical production form path and lead delivery path must be verified before further changes.
