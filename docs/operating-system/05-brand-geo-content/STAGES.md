...
- Entry condition: a worker is preparing to change Brand, GEO, and Content.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `docs/superpowers/specs/2026-06-29-yafest-geo-design.md`, `teatr_kino_sochi_tvorcheskiy_kampus.md`, `master_klassy_i_intensivy.md`, `pedagogi_i_napravleniya.md`; compare with code/tests where relevant; record conflicts as open questions.
