# Brand, GEO, and Content Flows

## Main lifecycle

1. Content fact enters as source evidence, is normalized into product map, appears visibly on pages, and then may be reflected in schema and llms.txt.
