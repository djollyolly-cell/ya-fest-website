...
- Entry condition: a worker is preparing to change Agent Runtime.
- Exit condition: `STATE.md` reflects verified code, files, docs, or external-state checks.
- Evidence/checks: read `docs/operating-system/AREA_TEMPLATE.md`; compare with code/tests where relevant; record conflicts as open questions.
