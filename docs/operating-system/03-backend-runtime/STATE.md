...
A React-side API contact endpoint and a static HTML PHP notification handler are present. Their production ownership and active deployment surface must be verified before changing public form behavior.
